...
function Faves ({ favorite, visitFaves, index, removeFaves }) {
    ...
    //default values are passed for display purposes
      {
        text: "https://github.com/tathagata1805"
      },
      {
        text: "https://www.tathagata1805.github.io/"
      },
      {
        text: "https://www.linkedin.com/in/tathagata-chakraborty-0bb5b71a3/"
      }
    ]);
    ...
    return (
      ...
      <div className="card">
        ...
        <Row>
            <Col className="col-md-8">
                <h3 className="cat-header">Go to Website</h3> 
            </Col>
            <Col className="col-md-4">
