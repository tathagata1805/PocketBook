                    ...
                    <form ref="NewNotes" onSubmit={this.saveNote}>
                        <div className="form-group">
                            ...
                            <p className="note_title">
                                ...
                                <input className="form-control" ref={title => this.title = title} defaultValue={this.props.note.title} placeholder="Wanna add something?"/>
                            </p>
                            {/* Renders a new note description*/}
                            <p className="note_desc">
                                <label className="noteDescTitle">Description</label>
                                <textarea className="form-control" rows="10" ref={description => this.description = description} defaultValue={this.props.note.description} placeholder="Mind adding some content! "/>
                            </p>
                        </div>
